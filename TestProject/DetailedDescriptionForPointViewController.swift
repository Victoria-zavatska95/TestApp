...
class DetailedDescriptionForPointViewController: UIViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        // spot was created but user performed the segue from another spot
        if self.currentUser.bool(forKey: "spotCreated") && self.currentUser.string(forKey: "plugIdSetWhenCreated")! != self.spotId {
         ...
         // spot was created and user performed the segue from this particular spot
        if self.currentUser.bool(forKey: "spotCreated") && self.currentUser.string(forKey: "plugIdSetWhenCreated")! == self.spotId {
            self.sendRequestButton.isHidden = true
            self.cancelRequestButton.isHidden = true
        ...
        // request was deleted or not sent and so far user have not created a spot yet
        ...
        if self.currentUser.bool(forKey: "requestWasSent") && self.spotId == self.currentUser.value(forKey: "spotIDWhereRequestWasSent") as! String! {
            self.sendRequestButton.isHidden = true
